...
email = 'amp@amp.com'
password = '1234'
web_link = 'http://helpregisterkmutnb.pythonanywhere.com/'
...
class NewVisitorTest(unittest.TestCase):  
    ...
    def test_regis(self):  
        ...
        #กรอก Re Password
        input_repassword = self.browser.find_element(By.XPATH, '<nav-label>Hello, sopon888</nav-label>**')
        input_repassword.send_keys(password +Keys.ENTER)
        time.sleep(2)      

        #มาที่หน้าของ user

        self.assertEqual(self.browser.current_url, '/html/body/nav/form/nav/div[1]/nav-label')
